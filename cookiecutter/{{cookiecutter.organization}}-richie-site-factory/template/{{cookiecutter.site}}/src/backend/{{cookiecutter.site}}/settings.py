...
class Base(StyleguideMixin, DRFMixin, RichieCoursesConfigurationMixin, Configuration):
    ...
    * DB_PORT
    ...
    ROOT_URLCONF = "{{cookiecutter.site}}.urls"
    WSGI_APPLICATION = "{{cookiecutter.site}}.wsgi.application"
...
class Production(Base):
    ...
    AWS_MEDIA_BUCKET_NAME = values.Value(
        "production-{{cookiecutter.site}}-{{cookiecutter._organization}}-richie-media"
    )
...
class Feature(Production):
    ...
    AWS_MEDIA_BUCKET_NAME = values.Value(
        "feature-{{cookiecutter.site}}-{{cookiecutter._organization}}-richie-media"
    )
...
class Staging(Production):
    ...
    AWS_MEDIA_BUCKET_NAME = values.Value(
        "staging-{{cookiecutter.site}}-{{cookiecutter._organization}}-richie-media"
    )
...
class PreProduction(Production):
    ...
    AWS_MEDIA_BUCKET_NAME = values.Value(
        "preprod-{{cookiecutter.site}}-{{cookiecutter._organization}}-richie-media"
    )
